                ...
                <tbody>
                  <tr>
                    ...
                    <td className="w-[37%] h-full">
                      <TextInput
                        value={siswa.wali?.nama || "Tidak ada data"}
                        className="h-full"
                      />
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="w-[37%] h-full">
                      <TextInput
                        value={siswa.wali?.tempat_lahir || "Tidak ada data"}
                        className="h-full"
                      />
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="w-[37%] h-full">
                      <DatePicker
                        selected={siswa.wali?.tanggal_lahir || new Date()}
                  ...
                  <tr>
                    ...
                    <td className="w-[37%] h-full">
                      <TextInput
                        value={siswa.wali?.agama || "Tidak ada data"}
                        className="h-full"
                      />
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="w-[37%] h-full">
                      <TextInput
                        value={siswa.wali?.kewarganegaraan || "Tidak ada data"}
                        className="h-full"
                      />
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="w-[37%] h-full">
                      <TextInput
                        value={siswa.wali?.pendidikan || "Tidak ada data"}
                        className="h-full"
                      />
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="w-[37%] h-full">
                      <TextInput
                        value={siswa.wali?.pekerjaan || "Tidak ada data"}
                        className="h-full"
                      />
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="w-[37%] h-full">
                      <TextInput
                        value={siswa.wali?.pengeluaran_per_bulan || "Tidak ada data"}
                        className="h-full"
                      />
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="w-[37%] h-full">
                      <TextInput
                        value={siswa.wali?.alamat_dan_no_telepon || "Tidak ada data"}
                        className="h-full"
                      />
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="w-[37%] h-full">
                      <TextInput
                        value={siswa.wali?.status || "Tidak ada data"}
